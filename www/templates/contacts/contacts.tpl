	...
	<?php if( isAdmin() ) { ?>
		<div class="row">
            ...
            <a class="button float-right" href="<?=HOST?>message">Сообщения</a>
				<a class="button button-edit float-right mr-20" href="<?=HOST?>contacts-edit">
				Редактировать</a>
			</div>
	<?php }?>
			<div class="col-5">
			...
			<div class="col-4 offset-1">
				...
				<form class="feedback-form" action="#!"><input class="input" name="name-user" type="text" placeholder="Введите имя" /><input class="input" name="email-user" type="email" placeholder="Email" /><textarea class="textarea mb-20" name="user-message" placeholder="Сообщение"></textarea>
					...
					</section><input class="button button-save mt-20" type="submit" name="save-button" value="Отправить" /></form>
			</div>
		</div>
	</div>