        ...
        <div class="col-10 offset-1">
            ...
            <form class="mt-35" action="<?=HOST?>edit" enctype="multipart/form-data" method="POST">
                <div class="user-edit-wrapper">
                    ...
                    <input class="input" name="subname" id="userEditLastname" type="text" placeholder="Введите фамилию" value="<?=$currentUser->subname?>" /></div>
                    <div class="user-edit-email mt-30"><label class="label" for="userEditEmail" >Email</label>
                    <input class="input" name="email" id="userEditEmail" type="email" placeholder="Введите email" value="<?=$currentUser->email?>"/></div>
                </div>
                ...
                <div class="user-edit-wrapper mt-30">
                    ...
                    <input class="input" name="country" id="userEditLand" type="text" placeholder="Введите страну" value="<?=$currentUser->country?>" /></div>
                    <div class="user-edit-city mt-30"><label class="label" for="userEditCity">Город</label>
                    <input class="input" name="city" id="userEditCity" type="text" placeholder="Введите город" value="<?=$currentUser->city?>"/></div>
                    <div class="user-edit-buttons mt-30">
                    <input class="button button-save" type="submit" name="update" value="Сохранить" />
                    <a href="<?=HOST?>profile" class="button">Отмена</a></div>
                </div>
            </form>
        </div>
    </div>
