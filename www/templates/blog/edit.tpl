    ...
    <div class="row m-0">
        <div class="col-10 offset-1 p-0">
            <div class="add-post-content">
                ...
                <form method="POST" action="<?=HOST?>blog/category-edit?id=<?=$cat['id']?>">
                    <div class="add-post-content__name mt-40">
                        <label class="label" for="inputCategory">Название категории</label>
                        <input class="input" name="categoryName" id="inputCategory" type="text" placeholder="Введите название категории" value="<?=$cat['cat_title']?>"/>
                    </div>
                    <div class="add-post-content__submit mt-30">
                        <input class="button button-save mr-20" type="submit" name="cat-edit" value="Обновить"/>
